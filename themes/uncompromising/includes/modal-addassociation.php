<!-- Modal -->
<div class="modal" id="modalAddAssociation">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Create Association For <?php echo $contact->firstname; ?></h4>
			...
			<div class="modal-body">
				<form name="addassociationform" class="needs-validation" id="needs-validation" method="post" action="<?php echo home_url( '/' ); ?>wp-content/themes/uncompromising/db/addassociation.php" novalidate>
					...
					<div class="row margin-bottom-20">
						<div class="col-sm-6">
							<label>Size</label>
							<select name="association_size" class="form-control">
