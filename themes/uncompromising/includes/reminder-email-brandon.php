...
$userdates = $wpdb->get_results( 
	...
	WHERE aud_dates.ID = 2 AND aud_dates.date_month IN (12,1,2)
...
$userassociations = $wpdb->get_results( 
	...
	WHERE aud_associations.ID = 2 AND aud_associations.birth_month IN (12,1,2)
...
$userdates = $wpdb->get_results( 
	...
	INNER JOIN aud_contacts
	ON aud_dates.contact_ID=aud_contacts.contact_ID
	WHERE aud_dates.ID = 2 AND aud_dates.date_month IN ($currentMonth, $nextMonth, $monthAfterNext)
