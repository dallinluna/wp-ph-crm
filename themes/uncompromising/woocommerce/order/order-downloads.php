	...
	<div class="card">
		<div class="card-block">
			<?php if ( isset( $show_title ) ) : ?>
				<h4 class="font-bold mb-3 text-uppercase woocommerce-order-downloads__title"><?php _e( 'Downloads', 'woocommerce' ); ?></h4>
			<?php endif; ?>

			<table class="woocommerce-table table woocommerce-table--order-downloads shop_table_responsive order_details">
				<thead>
					<tr>
							...
							<td class="<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>"><?php
								if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
									...
									switch ( $column_id ) {
										...
										break;
										case 'download-file' : ?>
											<a href="<?php echo esc_url( $download['download_url'] ); ?>" class="woocommerce-MyAccount-downloads-file btn btn-primary btn-sm"><i class="fal fa-download"></i> <?php echo esc_html( $download['download_name'] ); ?></a>
											<?php
										break;
