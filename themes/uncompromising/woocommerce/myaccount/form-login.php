...
<div class="card">
	<div class="card-block">
		...
		<h4 class="font-bold text-uppercase"><?php _e( 'Login', 'woocommerce' ); ?></h4>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<div class="row">
				...
				<div class="woocommerce-form-row woocommerce-form-row--wide form-row-wide form-group col-lg-6">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn btn-primary btn-lg" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
