...
<?php if ( $has_orders ) : ?>
	...
	<div class="card">
		<div class="card-block">
			...
			<table class="woocommerce-orders-table table woocommerce-MyAccount-orders shop_table_responsive my_account_orders account-orders-table">
				<thead>
					<tr>
									...
									<?php elseif ( 'order-actions' === $column_id ) : ?>
										...
										if ( ! empty( $actions ) ) {
											foreach ( $actions as $key => $action ) {
												echo '<a href="' . esc_url( $action['url'] ) . '" class="btn btn-link ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
											}
										}
										?>
									<?php endif; ?>
