 ...
 */
function uncompromising_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Uncompromising default saturation level.
	 *
	 * @since Uncompromising 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'uncompromising_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.uncompromising-front-page) .entry-title,
...
.colors-custom .uncompromising-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.uncompromising-front-page .panel-content .recent-posts article,
...
.colors-custom.uncompromising-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Uncompromising custom colors CSS.
	 *
	 * @since Uncompromising 1.0
	 *
	 ...
	 */
	return apply_filters( 'uncompromising_custom_colors_css', $css, $hue, $saturation );
}
